...
const Probability = () => {
  return (
    ...
    <div className='header'>
        <h2>Complete Probability & Statistics Course</h2><br />
        <h4>Everyone you need in Probability & Statistics in one course (including 3 real world projects)</h4><br />
        <Link to="/signup"><button to="/signup" className='enrollement_button'><AiOutlineShoppingCart/>&nbsp;&nbsp;Enroll Now Only In $85</button></Link>
    </div>
    <div className='lines'>
        <p>Probability & Statistics is the branch of mathematics that studies rates of change and infinitesimally small values. It provides a way to measure quantities that vary as the rate of change, such as interest rates, net worth, velocity, and acceleration.
        Probability & Statistics was developed around the year 1665 by two great thinkers: Gottfried Leibniz and Isaac Newton. Since its development, calculus has found application in a huge variety of fields, including physics, engineering, economics, and biology. It  Makes You Smarter, Increases Your Analytical Skills And Logical Reasoning Abilities, it enhances Your Problem-Solving Abilities, Teaches You How To Think Outside The Box,Enhances Your Learning Ability,it Helps You Excel In Engineering And Physics and  Sharpens Your Analytical Skills</p>
    </div>
    ...
    <Card className='info' style={{ width: '40rem' }}>
      <Card.Body>
        ...
        <Card.Text>
        Hi! My name is Fatima Ali. I'm PhD scholar with two decades of experience. I have taught millions of people the different concepts of Probability & Statistics. I believe calculus should be fun and easy for everyone.
        </Card.Text>
